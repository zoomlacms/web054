...
<%@ Import Namespace="ZoomLa.Sns" %>
            <table style="font-size:12px;line-height:20px;">
                ...
                <tr>
                    <td style="text-indent: 24px;" colspan="3">We are glad your order has been delivered.  Please contact us if there is a problem with the shipment, or  if you need any further information regarding your sign. We are here to help. 
