...
<div class="m_top_bottom nav-scroller">
	...
	<ul class="menu2 open nav nav-underline sys_overhid">
        <li><a class="nav-link active menu2_1 " onclick="ShowMain('NodeTree.ascx','Content/ContentManage.aspx');">按栏目管理</a></li>
        <li><a class="nav-link menu2_2 " onclick="ShowMain('SpecialTree.ascx?cate=0','Content/ContentManage.aspx')">按专题管理</a></li>
        <li><a class="nav-link menu2_2 " onclick="ShowMain('SpecialTree.ascx','Content/SpecialManage.aspx')">专题维护</a></li>
	...
	<ul class="menu3 nav nav-underline sys_overhid">
        ...
        <li><a class="nav-link active menu3_1 " onclick="ShowMain('SpecialTree.ascx?cate=1','Shop/ProductManage.aspx');">按专题管理</a></li>
...
<%--					<li id="menu3_5_1"><a href="javascript:;" data-url="/AdminMVC/Sale/SaleByDay">按日统计</a></li>
				...
				<ul id="menu3_6" class="m_left_ulin">
					...
					<li id="menu3_6_5"><a href="javascript:;" data-url="/Extend/Admin/Coupon.aspx"><%=Resources.L.优惠券管理 %></a></li>
				</ul>
			...
			<div id="menu7" class="m_left_ul">
				...
				<li class="pl-0"><p class="menu_tit laybtn below"><i class="zi zi_forDown" zico="下指"></i> 广告管理</p>
					<ul>
                        <!-- <li id="menu7_2_9"><a href="javascript:;" data-url="Plus/AD/Banner.aspx">Banner管理</a></li> -->
