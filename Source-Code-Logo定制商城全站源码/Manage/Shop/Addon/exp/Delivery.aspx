<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Delivery.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.Delivery" MasterPageFile="~/Common/Common.master"  %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <div class="container">
        ...
        <table class="mytable">
            ...
            <tr><td>邮件通知</td><td><asp:CheckBox runat="server" ID="Email_Chk" Checked="true"/></td></tr>
