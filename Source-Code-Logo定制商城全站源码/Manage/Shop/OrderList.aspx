<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderList.aspx.cs" Inherits="ZoomLaCMS.Manage.Shop.OrderList" MasterPageFile="~/Extend/Empty2.master" %>
...
<div id="maindiv">
    <ul id="ordernav" class="nav nav-tabs margin_t5">
       <li class="nav-item" data-type="all"><a class="nav-link active" href="<%=BaseUrl %>"><asp:Label runat="server" ID="order_all_l" Text="全部订单"></asp:Label></a></li>
       ...
       <li class="nav-item" data-type="prepay" style="display:none;"><a class="nav-link" href="<%=BaseUrl %>&filter=prepay"><asp:Label runat="server" ID="order_prepay_l" Text="预付款"></asp:Label></a></li>
