<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ArriveList.aspx.cs" Inherits="ZoomLaCMS.Cart.Comp.ArriveList" EnableViewState="false" %>
...
<div runat="server" visible="false" id="arrive_empty_div">
    <div class="alert alert-info">No coupons are available</div>
</div>
